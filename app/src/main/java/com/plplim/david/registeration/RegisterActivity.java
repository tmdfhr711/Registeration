...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = (Spinner) findViewById(R.id.registeractivity_majorSpinner);
        ...
        final Button validateButton = (Button) findViewById(R.id.registeractivity_validateButton);
        ...
        Button registerButton = (Button) findViewById(R.id.registeractivity_registerButton);
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RegisterRequest registerRequest = new RegisterRequest(userID, userPassword, userGender, userMajor, userEmail, resonseListener);
                RequestQueue queue = Volley.newRequestQueue(RegisterActivity.this);
