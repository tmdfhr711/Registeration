...
public class NoticeListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView noticeText = (TextView) v.findViewById(R.id.notice_noticeText);
        TextView nameText = (TextView) v.findViewById(R.id.notice_nameText);
        TextView dateText = (TextView) v.findViewById(R.id.notice_dateText);
